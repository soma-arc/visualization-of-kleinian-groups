...
図では中央に置いた絵を周囲の円の反転で移した軌道を描いた. 
軌道は最終的に極限集合へと収束していく. 
図\ref{fig:apr}はP.Nylander氏による作品\footnote{http://bugman123.com/Fractals/index.html}を参考に筆者が描画したものである．蝶が二つの元の作用で変換された軌道を極限集合とともに描いている．

\subsubsection{Rendering the Limit Set}

研究では, 前節でみた極限集合を直接描く方法が主に用いられる．
