...
クライン群について学習する際には書籍『インドラの真珠』\cite{komori-indra201303}(原著:\cite{MumfordSeriesWright200204})を読むことを勧める.
...
また，以下のように係数を２×２の複素数行列として扱うことで，代数として操作することが
できる．
...
そのためには有限オートマトンが使われる．
有限オートマトンに関する書籍には『Word Processing In Groups』\cite{Epstein:1992:wordProcessing}がある．
